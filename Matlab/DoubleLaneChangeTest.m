...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%
% Filename: DoubleLaneChangeTest.m
%
%
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% 
% A test programe before final doubleLaneChange function is developed according to this *main* program of single predefined double lane change
% 
%
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
...
[orientationVector timeVector] = generateOrientation(0,0,0,0.32,dt,'step');
[orientationVector timeVector] = ...
        generateOrientation(orientationVector,timeVector,17,0.55,dt,'ramp');
[orientationVector timeVector] = ...
        generateOrientation(orientationVector,timeVector,17,0.08,dt,'step');
[orientationVector timeVector] = ...
        generateOrientation(orientationVector,timeVector,0,0.55,dt,'ramp');
[orientationVector timeVector] = ...
        generateOrientation(orientationVector,timeVector,0,0.05,dt,'step');
[orientationVector timeVector] = ...
